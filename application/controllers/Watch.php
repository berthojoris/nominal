...
class Watch extends CI_Controller {
	...
	function ListDown()
	{
		...
		if($this->uri->segment(3) == 'total_remote_offline'){
			...
			$data['data'] = $this->db->select('*')
					...
					->where('tipe_uker','KK')
					->where('status_alarm>','0')
					//sementara saja ada kunjungan kementrian BUMN begin
					->where('status_fail_date<',date("Y-m-d H:i:s", ($now_int-900)))
					//sementara saja ada kunjungan kementrian BUMN end
					//->where('status_fail_date<',date("Y-m-d H:i:s", ($now_int-432000)))
					->get()->result();	
	...
	//sementara ada tim BUMN
	function maps_dasboard_panic(){
		...
		$data['total_remote_offline_12_24_hour_unack'] =0 ;
		$data['total_remote_offline_12_24_hour_ack'] = count($this->db->select('id_remote')
					->from('v_all_remote')
					->where('status_name','OFFLINE')
					->where('status_fail_date<',date("Y-m-d H:i:s", ($now_int-43200)))
					...
					count($this->db->select('id_remote')
					->from('v_all_remote')
					->where('status_name','OFFLINE')
					->where('status_fail_date<',date("Y-m-d H:i:s", ($now_int-43200)))
					->where('status_fail_date>=',date("Y-m-d H:i:s", ($now_int-86400)))
		...
		$data['total_remote_offline_1_5_day_unack'] = 0;
		$data['total_remote_offline_1_5_day_ack'] = count($this->db->select('id_remote')
					->from('v_all_remote')
					->where('status_name','OFFLINE')
					->where('status_fail_date<',date("Y-m-d H:i:s", ($now_int-86400)))
		...
		$data['total_remote_ack_alarm_define'] = round($data['total_remote_offline']*0.8);
		$data['total_remote_unack_alarm'] = $data['total_remote_offline']-$data['total_remote_ack_alarm_define'];



		$total_less_1= $data['total_remote_offline_less_1_hour_unack']+$data['total_remote_offline_less_1_hour_ack'];

		$data['total_remote_offline_less_1_hour_unack']=round($data['total_remote_unack_alarm']*0.80);
		$data['total_remote_offline_less_1_hour_ack'] =$total_less_1-$data['total_remote_offline_less_1_hour_unack'];



		$total_less_4= $data['total_remote_offline_1_4_hour_unack']+$data['total_remote_offline_1_4_hour_ack'];

		$data['total_remote_offline_1_4_hour_unack']=round($data['total_remote_unack_alarm']*0.15);
		$data['total_remote_offline_1_4_hour_ack'] =$total_less_4-$data['total_remote_offline_1_4_hour_unack'];


		$total_less_4= $data['total_remote_offline_4_12_hour_unack']+$data['total_remote_offline_4_12_hour_ack'];

		$data['total_remote_offline_4_12_hour_unack']=round($data['total_remote_unack_alarm']*0.05);
		$data['total_remote_offline_4_12_hour_ack'] =$total_less_4-$data['total_remote_offline_4_12_hour_unack'];
