...
<section style="margin-bottom: -20px">
    <div style="width:100%;height:38px;" class="panel panel-default">
      <ol class="breadcrumb" style="background: white;">
        ...
        <li class="active">List Request Routing</li>
      </ol>
    </div>
</section>
<section class="content">
  <div class="row">
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box" onclick="window.open('<?php echo base_url();?>index.php/Req_Routing/List/new','mywindow');" style="cursor: pointer;">
      <span class="info-box-icon bg-aqua"><i class="fa fa-arrow-down"></i></span>

      <div class="info-box-content">
        <span class="info-box-text">New Request Routing</span>
        <span class="info-box-number"><?php echo $new;?> Remotes</span>
      </div>
      <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
    ...
    <!-- /.col -->
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box" onclick="window.open('<?php echo base_url();?>index.php/Req_Routing/List/done','mywindow');" style="cursor: pointer;">
      <span class="info-box-icon bg-green"><i class="fa fa-check "></i></span>

      <div class="info-box-content">
        <span class="info-box-text">Routing Done</span>
        <span class="info-box-number"><?php echo $done;?> Remotes</span>
      </div>
      <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
    ...
    <!-- /.col -->
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box" onclick="window.open('<?php echo base_url();?>index.php/Req_Routing/List/reqroll','mywindow');" style="cursor: pointer;">
      <span class="info-box-icon bg-red"><i class="fa fa-exclamation-circle"></i></span>

      <div class="info-box-content">
        <span class="info-box-text">Request Rollback</span>
        <span class="info-box-number"><?php echo $reqroll;?> Remotes</span>
      </div>
      <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
    ...
    <!-- /.col -->
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box" onclick="window.open('<?php echo base_url();?>index.php/Req_Routing/List/rolldone','mywindow');" style="cursor: pointer;">
      <span class="info-box-icon bg-green"><i class="fa fa-check "></i></span>

      <div class="info-box-content">
        <span class="info-box-text">Rollback Done</span>
        <span class="info-box-number"><?php echo $rolldone;?> Remotes</span>
      </div>
      <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
  ...
  <div class="row">
    <div class="panel panel-default">
      <div class="panel-heading" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">List Request Routing</div>
      <div class="panel-body">
        <div style="width:100%;height:50px;">
            <div align="left" style="float: left;">
              <button type="button" class="btn btn-block btn-primary btn-xs" style="width: 150px;height:30px" onclick="show_form()"><i class="fa fa-plus"></i>&nbsp; Request Routing</button>
            </div>
        </div>
          ...
          <form role="form" id="formid">
            <div class="box-body">
                <div class="form-group">
                  <label>Remote</label>
                  <select class="form-control select2" name="remote" id="remote" style="width: 100%;" required>
                      <option value="">
                        -- Change Remote --
                      </option>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="ip_pool" id="ip_pool" class="form-control" value="" required> <!-- data-inputmask="'alias': 'ip'" data-mask > -->
                  </div>
                </div>
                <div class="form-group">
                  <label>Ticket</label>
                  <input type="text" name="ticket_jarkom" id="ticket" class="form-control" required>
                </div>
            </div>
            <!-- /.box-body -->
            ...
            <div class="box-footer">
              ...
              <button type="button" name="submit" value="submit" class="btn btn-primary pull-right" onclick="save_req()">Save</button>
            </div>
          </form>
        </div>
          ...
          <form role="form" id="formrollback">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="pic_rollback" name="pic_rollback" placeholder="Enter PIC">
                </div>
                <div class="form-group">
                  <label>NOTE</label>
        ...
        <form role="form" id="formid">
            <div class="box-body">
              <input type="hidden" name="id_req" id="id_req">
                    ...
                    <tr  id="routing" style="display: none;">
                      ...
                      <td colspan="6">
                        <select class="form-control" name="status_routing" id="status_routing" onchange="Cekrouting()" disabled>
                          ...
                          <option id="select_routing3" value="3">Routing Ready</option>
                ...
                <div class="form-group" id="btn_closereq" style="display: none;">
                  <button type="button" class="btn btn-danger" onclick="CloseReq()"><i class="fa fa-close"></i> Cancel Request Routing</button>
                </div>

                <div class="form-group" id="btn_rollback3" style="display: none;">
                  <label style="margin-right: 50px">Rollback</label>
                  <button type="button" class="btn btn-success" onclick="RoutDone()" id="routdone"><i class="fa fa-check"></i> Routing Done</button>
                  <button type="button" class="btn btn-success" onclick="DeakSIM()" id="simdeac"><i class="fa fa-check"></i> SIM Card Deactiveted</button>
                </div>
...
<script type="text/javascript">
  ...
  function tampilkan_data()
  {
    $("#table_data").DataTable({
      ...
      ajax:{
        url:"<?php echo base_url().'index.php/Req_Routing/GetData_ReqRouting';?>",
        type:"post",
        dataType:"json"
  ...
  function DetailReq(id='') {
    ...
    $.ajax({
      ...
      success : function(data){
        ...
        if(data.status==11){
        ...
        }else if(data.status==12 && data.status_routing==4 && data.status_simcard==4){
          ...
          if (data.status_routing == 4) { document.getElementById("routdone").disabled = true; data.status_routing=3;}
          if (data.status_simcard == 4) { document.getElementById("simdeac").disabled = true; data.status_simcard=3;}
        ...
        if (data.status_open==3 && data.status<11) {
          ...
          //}
          	...
          	// if (data.status_simcard==3) {
          	// 	document.getElementById("status_routing").disabled = true;
           //    	$("#btn_routing").hide();
          	// }

            if (data.status_routing==0) {
              $("#txt_reason2").show();
            }

            if (data.status_simcard==0) {
              $("#txt_reason3").show();
            }

        }

        if (data.status_open==0 && data.status<13) {
          $("#btn_closereq").show();
        }
  ...
  function CloseReq() {
    ...
    $.ajax({
      ...
      success: function(data)
      {
        if (data==true) {
          swal({
              title:"Close Request Routing Success!", 
              type: "success",
              timer: 20000,   
              confirmButtonText: "Ok"},
            function(){
          ...
          swal("Oops","Error Close Request Routing", "error");
        }
    ...
    $.ajax({
      ...
      success: function(data)
      {
        if (data==true) {
          ...
          swal("Oops","Error Routing Done", "error");
        }
  ...
  function DeakSIM() {
    ...
    $.ajax({
      ...
      success: function(data)
      {
        if (data==true) {
          swal({
              title:"Deactiveted SIM Card Success!", 
              type: "success",
              timer: 20000,   
              confirmButtonText: "Ok"},
            function(){
          ...
          swal("Oops","Error Deactiveted SIM Card ", "error");
        }
