      ...
      <div class="panel-heading" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">
        ...
        switch ($this->uri->segment(3)) {
          case 'newopen':
            ...
            break;
          case 'checkopen':
            echo "List Checking Open";
            break;
          case 'veropen':
            echo "List Verfied Open";
            break;
          case 'rejopen':
            echo "List Reject Open";
            break;
          case 'newrout':
            echo "List New Routing";
            break;
          case 'checkrout':
            echo "List Checking Routing";
            break;
          case 'verrout':
            echo "List Routing Ready";
            break;
          case 'rejrout':
            echo "List Reject Routing";
            break;
          case 'newsim':
            echo "List New SIM Card";
            break;
          case 'checkopen':
            echo "List Checking SIM Card";
            break;
          case 'versim':
            echo "List SIM Card Ready";
            break;
          case 'rejopen':
            echo "List Reject SIM Card";
            break;
          case 'new':
            echo "List New Request Routing";
            break;
          case 'done':
            echo "List Routing Done";
            break;
          case 'reqroll':
            echo "List Request Rollback";
            break;
          case 'rolldone':
            echo "List Rollback Done";
            break;
          case 'proroll':
            echo "List Progress Rollback";
            break;
        }
        ?>
      </div>
...
<script type="text/javascript">
  ...
  function tampilkan_data()
  {
    ...
    $("#table_data").DataTable({
      ...
      ajax:{
        url:"<?php echo base_url().'index.php/Req_Routing/GetData_ReqRouting/';?>"+kategori,
        type:"post",
        dataType:"json"
