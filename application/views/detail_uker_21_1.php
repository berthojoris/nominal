                ...
                <div style="width:100%;height:100%;position:relative;">                          
                      <table class="table table-hover">
                        ...
                        <tr>
                          <th>MAIN BRANCH</th>
                          <td style="width: 10px">:</td>
                          <td><?php echo strtoupper($data[0]->nama_kanca);?>&nbsp;(<?php echo($locinduk[$data[0]->id_remote][0]->latitude.",".$locinduk[$data[0]->id_remote][0]->longitude); ?>)</td>
                        </tr>
                        <tr>
                          <th>IP LAN</th>
                          <td style="width: 10px">:</td>
                        ...
                        <tr>
                          <th>NOTE ALARM</th>
                          <td style="width: 10px">:</td>
                          <td><?php echo $data[0]->note_alarm;?></td>
                        </tr>
                        <tr>
                          <th>STATUS ALARM</th>
                          <td style="width: 10px">:</td>
                          ...
                          <table class="table table-hover" style="width: 350px;">
                              ...
                              <tr>
                                <td colspan="3">
                                  ...
                                  <?php }?>
                                    <button type="button" class="btn-xs btn-primary" data-toggle="modal" data-target="#table_history<?php echo $jar->id_jarkom;?>" onclick="AlarmJarkom(<?php echo $jar->kode_jarkom;?>)">
                                      History Alarm
                                    </button>
                                  </div>
                        <?php if($jar->status==1 && in_array($this->session->userdata('role'),array(1,5))){?>
                                  <div class="input-group-btn">
                                    <button type="button" class="btn-xs btn-primary dropdown-toggle" data-toggle="dropdown">Action
                                      <span class="fa fa-caret-down"></span></button>
                                    <ul class="dropdown-menu">
                                      <li><button style="background-color: Transparent;border: none;color:#777777;width: 100%;text-align:left" onclick="ActionAckByJarkom('<?php echo base_url().'index.php/Master/ActionAckByJarkom/'.$jar->id_jarkom;?>')">Ack</button></li>
                                      <li><button style="background-color: Transparent;border: none;color:#777777;width: 100%;text-align:left" data-toggle="modal" data-target="#edit_alarm" onclick="GetAlarm(<?php echo $jar->id_jarkom;?>)">Edit Alarm</button></li>
                                    </ul>
                                  </div>
                            <?php }?>
                                </td>
...
<div class="modal fade" id="table_history<?php echo $jar->id_jarkom;?>">
  <div class="modal-dialog" style="width: 1200px">
    <div class="modal-content" >
      ...
      <div class="modal-body">
        <table class="table table-bordered table-striped table-hover" id="table_data_alarm" >
          <thead>
            <tr>
              <th>No.</th>
              <th>Alarm Id</th>
