...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-heading" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">Network Monitoring - Region <?php echo $nama_kanwil[0]->nama_kanwil;?> - Remote Type (<?php echo $tipe_uker[0]->tipe_uker;?>)</div>
            ...
            <div style="width:100%;height:50px;">
              <span style="float: right;">
                <?php
                  ...
                  $kode_op = $this->uri->segment(6);
                ?> 
                <a href="<?php echo base_url().'index.php/Dashboard/uker_excel/per_kanwil/'.$status.'/'.$kanwil.'/'.$kode_tipe_uker.'/'.$kode_op;?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px">
                Export Excel
                </button></a>
              </span>
