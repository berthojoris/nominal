        ...
        <div class="panel-body">
            <div style="width:100%;height:50px;">
              <span style="float: right;">
                <a href="<?php echo base_url().'index.php/Dashboard/uker_excel/uker/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px">
                Export Excel
                </button></a>
              </span>
            </div>
...
<script>
  ...
  function tampilkan_data()
  {
    $("#table_data").DataTable({
      ...
      ajax:{
        url:"<?php echo base_url().'index.php/Dashboard/tampil_table/tipe_uker/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>",
        type:"post",
        dataType:"json"
