        ...
        <div class="panel-body">             
            <div style="width:100%;height:50px;">
              <span style="float: right;">
                ...
                Export Excel
                </button></a>&nbsp;<a href="<?php echo base_url();?>index.php/Dashboard/data_uker_kanca/<?php echo $nama[0]->kode_kanca; ?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px;">Switch Style </button></a>
              </span>
			  
            </div>
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-striped" id="uker_kanca">
                <thead>
                  <tr>
                    <th>No.</th>
                    <th>Remote Name</th>
