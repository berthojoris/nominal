        ...
        <div class="panel-body">
            <div style="width:100%;height:50px;">
              <span style="float: right;">
                ...
                Export Excel
                </button></a>&nbsp;<a href="<?php echo base_url();?>index.php/Dashboard/data_uker2/<?php echo $data[0]->kode_kanca.'/'.$data[0]->kode_tipe_uker; ?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px;">Switch Style </button></a>
              </span>
            </div>
