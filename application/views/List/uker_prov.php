                                  ...
                                  <form role="form" action="" id="form<?php echo $datas->kode_jarkom;?>" method='post'>
                                    <div class="box-body">
                                      <div class="row">
                                        ...
                                        <input type="hidden" name="id_remote" value="<?php echo $datas->id_remote;?>">
                                        <!-- <div class="col-md-6"> -->
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select class="form-control" name="used_status">
                                              <option value="1" 
                                                <?php echo $datas->used_status == 1 ? 'selected' : ''?> > Enable
                                              </option>
                                              <option value="0" 
                                                <?php echo $datas->used_status == 0 ? 'selected' : ''?> > Disable
                                              </option>
                                            </select>
                                          </div>
                                          <div class="form-group">
