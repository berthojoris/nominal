...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-heading" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">Network Monitoring - Region <?php echo $kanwil[0]->nama_kanwil;?> - Main Branch <?php echo $kanca[0]->nama_kanca;?> - <?php echo($nama_uker[0]->tipe_uker); ?> </div>
        <div class="panel-body">
            <div style="width:100%;height:50px;">
              <span style="float: right;">
                <a href="<?php if($data) {echo base_url().'index.php/Dashboard/uker_excel/uker/'.$data[0]->kode_kanca.'/'.$data[0]->kode_tipe_uker;}?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px">
                Export Excel
                </button></a>&nbsp;<a href="<?php echo base_url();?>index.php/Dashboard/data_uker/<?php echo $data[0]->kode_kanca.'/'.$data[0]->kode_tipe_uker; ?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px;">Switch Style </button></a>
              </span>
            </div>
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-striped" id="uker">
                <thead>
                  <tr>
                    <th>No.</th>
                    <th>Remote Name</th>
