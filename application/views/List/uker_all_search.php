            ...
            <div style="width:100%;height:50px;">
              ...
              <div align="right">
                ...
                <tr>
                 ...
                 <!--  <td>
                    &nbsp;<a href="<?php echo base_url();?>index.php/Dashboard/All_uker_search2/<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4); ?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px;">Switch Style </button></a>
                  </td> -->
                </tr>
                </table>
              </div>
      ...
      <div class="box-body table-responsive no-padding">
        ...
        <table class="table table-bordered table-striped table-hover" >
          ...
          <tbody>
            ...
            <?php $no++; }}else{?>
              <tr><td colspan="11"><h4 align="center">Data Not Found</h4></td></tr>
            <?php }?>
          </tbody>
        </table>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="pic_uker" id="pic_uker" class="form-control">
                        </div>
                        <div class="form-group">
