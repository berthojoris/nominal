          ...
          <div class="box">
            <div class="box-header"> 
              <div style="float: left;">
                <h3 class="box-title" style="font-weight: bold ">List Network - Provider <?php echo $this->uri->segment(6); ?></h3>
              </div>
              <div class="box-tools">
                <?php
                ...
                ?>
                <!-- <form method="POST" action="<?php //echo base_url().'index.php/Dashboard/uker_prov_search/'.$kode_provider.'/'.$kode_jenis_jarkom.'/'.$brisat.'/'.$name.'/'; ?>"> -->
