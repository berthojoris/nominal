    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">             
            <div style="width:100%;height:50px;">
              <input type="hidden" name="url" id="url" value="<?php echo base_url().'index.php/Dashboard/All_uker_search2/'; ?>">
              <div align="right">
                <table>
                <tr>
                  <td>
                ...
                <td>
                  ...
                  <td>
                    &nbsp;<a href="<?php echo base_url();?>index.php/Dashboard/All_uker_search"><button type="button" class="btn btn-primary btn-sm" style="width: 100px;">Switch Style </button></a>
                  </td>
                </tr>
                </table>
              </div>
