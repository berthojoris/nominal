                                    ...
                                    <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select class="form-control" name="kode_kanca">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <!-- <input type="text" name="ip_lan" class="form-control" value="<?php echo $data[0]->ip_lan;?>"> -->
                                        </div>
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label>PIC PINCA</label>
                                          <input type="text" name="pic_pinca" class="form-control" value="<?php echo $data[0]->pic_pinca;?>">
                                        </div>
                                        <div class="form-group">
                                          <label>PIC SPO</label>
                                          <input type="text" name="pic_spo" class="form-control" value="<?php echo $data[0]->pic_spo;?>">
                                        </div>
                                        <div class="form-group">
                                          <label>PET IT</label>
                                          <input type="text" name="pet_it" class="form-control" value="<?php echo $data[0]->pet_it;?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                          <label>ADDRESS</label>
                                          <input type="text" name="alamat" class="form-control" value="<?php echo $data[0]->alamat_uker;?>">
                                        </div>
                                        <div class="form-group">
        ...
        <div class="panel panel-default" style="width:100%;"> 
            <div class="panel-heading" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">NETWORK DETAIL</div>            
                  <?php $no=1; foreach ($jarkom[$data[0]->id_remote] as $jar){?>
                      <div class="panel panel-default" style="width:30%;margin:5px;"> 
