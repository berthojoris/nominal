        ...
        <ul class="sidebar-menu">
            ...
            <li <?php if ($page == 'quick') {echo 'class="active"';} ?>>
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="<?=base_url()?>index.php/ApiSimcard/batchUpdate">
                        <i class="fa fa-search"></i>
            ...
            <li class="treeview"  <?php if ($page == 'kanwil' || $page == 'prov'|| $page == 'provbar' || $page == 'dashboard') {echo 'class="active"';} ?> >
                <a href="#">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if(in_array( $this->session->userdata('role'), array(1,2,3,5,10))){?>
                    <li <?php if ($page == 'provbar') {echo 'class="active"';} ?>>
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li <?php if ($page == 'provbar') {echo 'class="active"';} ?> > <a href="<?php echo base_url('index.php/Dash_Provider/Bar_dashboard'); ?>">
                                <i class="fa fa-bar-chart"></i>
                    ...
                    <?php }?>
                    <?php if(in_array( $this->session->userdata('role'), array(1,5,6,10) )){?>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li <?php if ($page == 'watch-lebaran') {echo 'class="active"';} ?>>
                                <a href="<?php echo base_url('index.php/Watch/militan_lebaran'); ?>">
                                <i class="fa fa-eye"></i>
                                <span>Lebaran Watch 2019</span>
                                </a>
                            </li>
                            <li <?php if ($page == 'watch-lebaran') {echo 'class="active"';} ?>>
                                <a href="<?php echo base_url('index.php/Watch/militan_lebaran_v2'); ?>">
                                <i class="fa fa-eye"></i>
                                <span>Lebaran v2 2019</span>
                                </a>
                            </li>
                            <li <?php if ($page == 'watch-lebaran') {echo 'class="active"';} ?>>
                                <a href="<?php echo base_url('index.php/Watch/dirkom'); ?>">
                                <i class="fa fa-eye"></i>
                                <span>Dir-Comm Attention</span>
                                </a>
                            </li>
                            <li <?php if ($page == 'office-watch') {echo 'class="active"';} ?>>
                                <a href="<?php echo base_url('index.php/Watch/office_region'); ?>">
                                <i class="fa fa-eye"></i>
                                <span>Office Reg Watch</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <?php if(in_array( $this->session->userdata('role'), array(1,5,6,10) )){?>
                    <li class="treeview">
                        <a href="#"><i class="fa fa-circle"></i>Weathermap
                        <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                        </span>
                        </a>
                        <ul class="treeview-menu">
                            <li <?php if ($page == 'main-branch-watch') {echo 'class="active"';} ?>>
                                <a href="<?php echo base_url('index.php/Watch/weathermap_dc'); ?>">
                                <i class="fa fa-circle"></i>
                                <span>DC Weathermap</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="treeview <?php if (in_array($page, $operation)) {echo 'active';} ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        <a href="#"><i class="fa fa-book"></i>Data Latency
                        <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                        </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="#"><i class="fa fa-file-text-o"></i>Report Latency</a></li>
                            <li><a href="#"><i class="fa fa-bar-chart"></i>Chart Latency</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview  <?php if ($page == 'reporting' || $page == 'main-branch-watch' 
                ...
                <ul class="treeview-menu">
                    ...
                    <li <?php if ($page == 'request-report') {echo 'class="active"';} ?>>
                        <a href="<?php echo base_url('index.php/Report/offline_report'); ?>">
                        <i class="fa fa-file-text-o"></i>
                ...
                <li class="treeview  <?php if ($page == 'adm-operation/relokasi' || $page == 'adm-operation/upgrade-bw' || $page == 'adm-operation/dismantle' || $page == 'adm-operation/psb' || $page == 'adm-operation/realokasi' || $page == 'adm-operation/reaktifasi' || $page == 'adm-operation/baol') {echo 'active';} ?>">
                    ...
                    <ul class="treeview-menu">
                        <li <?php if ($page == 'adm-operation/relokasi') {echo 'class="active"';} ?>>
                            <a href="<?php echo base_url('index.php/relokasi'); ?>">
                            <i class="fa fa-desktop"></i>
                            <span>Relokasi</span>
                            </a>
                        </li>
