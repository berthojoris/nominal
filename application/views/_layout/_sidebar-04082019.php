    ...
    <section class="sidebar">
      ...
      <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview  <?php if ($page == 'kanwil' || $page == 'prov' || $page == 'dashboard') {echo 'active';} ?>">
              <a href="#">
          ...
          <?php if(in_array( $this->session->userdata('role'), array(1,5) )){?>
            ...
            <li class="treeview <?php if ($page == 'maps' || $page == 'mapsfull') {echo 'active';} ?>">
              <a href="#">
          ...
          <?php }
           if(in_array( $this->session->userdata('role'), array(1,2,3,5,6,10) )){
		  ...
		  <?php if(in_array( $this->session->userdata('role'), array(1,5) )){?>
            ...
            || $page == 'event'|| $page == 'table_shift') {echo 'active';} ?>">
              ...
              <ul class="treeview-menu">
				...
				<li <?php if ($page == 'maps-dashboard') {echo 'class="active"';} ?>><a href="<?php echo base_url('index.php/watch/maps_dasboard'); ?>">
                      <i class="fa fa-tachometer"></i>
                      <span>Maps Dashboard</span>
                    </a>
                </li>
				<li <?php if ($page == 'alarm-watch') {echo 'class="active"';} ?>><a href="<?php echo base_url('index.php/watch/dashboard_down'); ?>">
                      <i class="fa fa-tachometer"></i>
