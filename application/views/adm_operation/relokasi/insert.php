<div class="modal fade" id="add_form_relokasi">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
                ...
                echo form_open_multipart('relokasi/saverelokasi', $attributes);
                ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control input-sm" name="network_id_old" id="network_id_old" required readonly>
                                </div>
                            </div>
                            <div class="form-group row">
