    ...
    <div class="row">
        <div class="panel panel-default" style="float: left;width:55%;">
            ...
            <div class="panel-body">
                <div>
                    <a href="<?php echo base_url();?>index.php/Dashboard/data_uker_kanca/<?php echo $kanca;?>"><button type="button" class="btn btn-primary btn-sm" style="width: 49%;">List Remote (<?php echo $nama_kanca;?>)</button></a>
