<form class="col-md-12" id="request_form" data="4">
	...
	<div class="col-md-12 formChild">
		...
		<div class='input-group date'>
	  		<input type="text" name="start_time" id="start_time_request" class="form-control start_time" value="<?=$start_time?>"></input><br>
	...
	<div class="col-md-12 formChild">
		...
		<div class='input-group date'>
	  		<input type="text" name="end_time" id="end_time_request" class="form-control end_time" value="<?=$end_time?>"></input><br>
	  		<span class="input-group-addon">
			    <span class="glyphicon glyphicon-calendar"></span>
			 </span>
		</div>
	...
	<div class="col-md-12 formChild">
		...
		<div style="position:relative;">
				...
				<span class="fa fa-paperclip"></span>
					Choose File...
					<input class="update_file_attach" id="file_attach_request_update" type="file" style='position:absolute;top:0;left:0;opacity: 0;height: 35px;cursor: pointer' name="file_source[]" size="40"  multiple="multiple" >
				</div>
			&nbsp;
							
		</div>
		<span class="error_message" id="request_attachment" style="display: none">message error</span><br>	
			<!-- <div  class="upload_file_info" data="file_attach_request_update" style="margin-top: 10px;"></div> -->
		

		 <div class="upload_file_info" data="file_attach_request_update" style="margin-top: 10px;">
	...
	<div class="col-md-12">
		...
		<button type="reset" id="request" name="btn_cancel" class="btn btn-danger" onclick="window.location='<?=base_url()?>index.php/EventReport/tableEvent' ">
