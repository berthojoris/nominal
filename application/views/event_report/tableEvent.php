...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-heading" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">Event List <?php echo strtoupper($this->uri->segment(3));?></div>
        <div class="panel-body">

        	<div id="warning"  class="alert alert-success" style="display: none;"><strong>alert</strong></div>
			...
			<div class="modal-body col-md-12">
				...
				<form class="col-md-12" id="plan_and_maintenance_form" data="1">
						...
						<label> File Attachment :</label><br/>
						 <div style="position:relative;">
							<div class='btn btn-primary'>
								...
								Choose File...
								<input class="file_attach" id="file_attach_plan" type="file" style='position:absolute;top:0;left:0;opacity: 0;height: 35px;cursor: pointer' name="file_source[]" size="40"  multiple="multiple" >
							</div>
							&nbsp;
							
						</div>
						<span class="error_message" id="plan_attachment" style="display: none">message error</span><br>	
						<div  class="upload_file_info" data="file_attach_plan" style="margin-top: 10px;"></div>
					</div>
					...
					<div class="col-md-12" style="margin-top: 15px;">
						...
						<button type="reset" id="plan" name="btn_cancel" class="btn btn-danger">
			...
			<div class="modal-body col-md-12">	
				<form class="col-md-12" id="incident_form" data="2">
					...
					<div class="col-md-12">
						...
						<div class="impact" style="width: 100%;height:354px;padding:1px 3px 1px 1px;border-radius:3px; ">
							<textarea id="impact_textarea" name="impact" class="form-control" rows="30"></textarea><br/>
						</div>
						...
						<label> File Attachment :</label><br/>
						 <div style="position:relative;">
							<div class='btn btn-primary'>
								<span class="fa fa-paperclip"></span>
								Choose File...
								<input class="file_attach" id="file_attach_incident" type="file" style='position:absolute;top:0;left:0;opacity: 0;height: 35px;cursor: pointer' name="file_source[]" size="40"  multiple="multiple" >
							</div>
							&nbsp;
							
						</div>
						<span class="error_message" id="incident_attachment" style="display: none">message error</span><br>	
						<div  class="upload_file_info" data="file_attach_incident" style="margin-top: 10px;"></div>
					</div>
					...
					<div class="col-md-12">
						...
						<button type="reset" id="incident" name="btn_cancel" class="btn btn-danger">
							<span class="fa fa-remove"></span>
							cancel
						</button>&nbsp;
					</div>
			...
			<div class="modal-body col-md-12">
				...
				<form class="col-md-12" id="activity_form" data="3">
						...
						<label> File Attachment :</label><br/>
						 <div style="position:relative;">
							<div class='btn btn-primary'>
								<span class="fa fa-paperclip"></span>
								Choose File...
								<input class="file_attach" id="file_attach_activity" type="file" style='position:absolute;top:0;left:0;opacity: 0;height: 35px;cursor: pointer' name="file_source[]" size="40"  multiple="multiple" >
							</div>
							&nbsp;
							
						</div>
						<span class="error_message" id="activity_attachment" style="display: none">message error</span><br>	
						<div  class="upload_file_info" data="file_attach_activity" style="margin-top: 10px;"></div>
					</div>
					...
					<div class="col-md-12">
						...
						<button type="reset" id="activity" name="btn_cancel" class="btn btn-danger">
							<span class="fa fa-remove"></span>
							cancel
						</button>&nbsp;
					</div>
			...
			<div class="modal-body col-md-12">
				...
				<form class="col-md-12" id="request_form" data="4">
					...
					<div class="col-md-12">
						...
						<span class="error_message" id="reporter" style="display: none;">message error</span><br>
						<button type="button" class="btn btn-primary btn-xs add_reporter" data="reporter4">
						<span class="fa fa-user"></span>	
						add reporter
						</button><br/><br/> 
						<div class="list_data_reporter" name="reporter"></div>
						...
						<label> File Attachment :</label><br/>
						 <div style="position:relative;">
							<div class='btn btn-primary'>
								<span class="fa fa-paperclip"></span>
								Choose File...
								<input class="file_attach" id="file_attach_request" type="file" style='position:absolute;top:0;left:0;opacity: 0;height: 35px;cursor: pointer' name="file_source[]" size="40"  multiple="multiple" >
							</div>
							&nbsp;
							
						</div>
						<span class="error_message" id="request_attachment" style="display: none">message error</span><br>	
						<div  class="upload_file_info" data="file_attach_request" style="margin-top: 10px;"></div>
					</div>
					...
					<div class="col-md-12">
						...
						<button type="reset" id="request" name="btn_cancel" class="btn btn-danger">
							<span class="fa fa-remove"></span>
							cancel
						</button>&nbsp;
					</div>
...
<script type="text/javascript">
  ...
  $(document).on("change",".file_attach",function(event){
  		id=$(this).attr("id");
  		//alert(id);
		event.preventDefault();
  		totalFile=document.getElementById(id).files.length;
  		//fileName=document.getElementById(id).files[0].name;
  		//console.log(fileName);

  		dataFile="";
  		for(a=0;a<totalFile;a++)
  		{
  			idFile="file"+a;
  			idArea="area"+id;
  			...
  			dataFile +="<div class='p-list-attach' style='display:block;cursor:pointer;' id='"+idFile+"' data='"+fileName+"'>";
  			dataFile +="<span class='glyphicon glyphicon-file'></span>";
  			dataFile += fileName;
  			dataFile +="</div>";
  ...
  $(document).on("click",".p-list-attach",function(){
   ...
   $(document).on("click",".add_reporter",function(){
		...
		if(reporter == 0)
		{
			...
			list="<div data='"+reporterId+"' class='data_reporter' style='margin-right:5px;'>";
			list+="<i class='fa fa-user'></i>&nbsp;";
			list+=reporterId+" - "+reporterName;
  ...
  $(document).on("click",".add_enginer",function(){
	...
	if(enginer == 0)
	{
		...
		list="<div data='"+enginerId+"' class='data_enginer'>";
		list+="<i class='fa fa-user'></i>&nbsp;";
		list+=enginerId+" - "+enginerName;
		list+="&nbsp;<span title='"+enginerId+"' class='glyphicon glyphicon-trash btn_delete_enginer' style='cursor:pointer;'></span>";
		list+="</div>";					  			
		$(".list_data_enginer").append(list);
  ...
  $(document).on("submit","form",function(e){
	    ...
	    */
  		...
  		{
  			//alert(a);
  			// p-list-attach fileName
  			data=dataAttachment.eq(a).attr("data");//here...
	  ...
	  data_input.append("list_attachment",list_fixed_attach);
  		...
  		$.ajax({
  			...
  			{				
  				...
  				for(a=0; a < error_message.length; a++)
  				{
  					...
  					if(fieldClass=="reporter" || fieldClass=="location" || fieldClass=="activity" || fieldClass=="note" || fieldClass=="enginer" || fieldClass=="root_cause" || fieldClass=="action" || fieldClass=="impact")
  					{
  				...
  				{
	  					//alert("success");
	  					$("#warning").html("<p style='color:white;font-weight:bold;'>FROM CREATED</p>");
	  					$("#warning").fadeIn(3000);
	  					$("#warning").fadeOut(5000);
	  					$(".upload_file_info").html('');
  				...
  				}else if(response.results=="incomplete")
  					{
  						for(a=0; a < response.field.length; a++)
  						{
  							...
  							if(response.field[a] =="reporter" || response.field[a] =="location" || response.field[a] =="activity" || response.field[a] =="note" || response.field[a] =="enginer" || response.field[a] =="root_cause" || response.field[a] =="action" || response.field[a] =="impact")
  							{
  						...
  						{
  							alert(response.results); //here.. error_message
  							area_message=$(".error_message");

  							switch( type_report )
  							{
  								case "1": id="plan_attachment";break;
  								case "2": id="incident_attachment";break;
  								case "3": id="activity_attachment";break;
  								case "4": id="request_attachment";break;
  							...
  							// id=area_message.attr("id");
  							// alert(id);

  							/*for(a=0;a<area_message.length;a++)
  							{
  								id=area_message.eq(a).attr("id");

  								
  								if( id=="plan_attachment" || id=="incident" || id=="activity" || id=="request")
  								{
  									area_message.eq(a).html(response.message);
  									area_message.eq(a).css({"color":"red","font-weight":"bold"});
  									area_message.eq(a).slideDown("slow");
 ...
 $(document).on("click",".btn_delete_email",function(){
  ...
  $(document).on("click",".list_type_report",function(){
   ...
   $(document).on("click","button[name=btn_cancel]",function(){
