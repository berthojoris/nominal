...
<section class="content" id="full" style="margin-top: -20px">   
    ...
    <div class="row">
        ...
        <a href="<?php echo base_url();?>index.php/Dashboard/data_uker_kanwil/<?php echo $kanwil;?>"><button type="button" class="btn btn-primary btn-sm" style="width: 250px">List Remote (<?php echo $nama_kanwil;?>)</button></a>&nbsp;
