...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-heading" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">Network Monitoring for Priority ATMs<?php echo strtoupper($this->uri->segment(3));?></div>
        <div class="panel-body">             
            <div style="width:100%;height:50px;">
              <span style="float: right;">
                <a href="<?php echo base_url().'index.php/Dashboard/uker_excel/testTable/'.$this->uri->segment(3);?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px">
                Export Excel
                </button></a><!-- &nbsp;<a href="<?php echo base_url();?>index.php/Dashboard/data_uker_kanwil2/<?php echo $nama[0]->kode_kanwil; ?>"><button type="button" class="btn btn-primary btn-sm" style="width: 100px;">Switch Style </button></a> -->
              </span>
			  
            </div>
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-striped table-hover" id="uker_kanwil">
                <thead>
                  <tr>
                    <th>No.</th>
                    <th>Remote Name</th>
                ...
                <tbody>
                <?php $no=$this->uri->segment(5)+1; foreach ($priority_atm as $datas) 
				{
					if($datas->status==1 && $datas->kode_op==2)
					{
					}
					else{
					?>
                  ...
                  <tr>					
                    ...
                    <td>
                      <?php 
                        foreach ($jarkom_priority_atm[$datas->id_remote] as $jarkoms) {
                          if ($jarkoms->brisat==1) {
                            if ($jarkoms->status==3) {
