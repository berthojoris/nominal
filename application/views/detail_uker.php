	...
	<div class="row" id="div-graph">
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">
				<span id="portname"></span>&nbsp;-&nbsp;GRAPH<a style="float:right;color:white;" onclick="closeGraph();" ><i class='fa fa-close' style="cursor:pointer;"></i></a></div>     
...
<!-- PORT GRAPHS -->
<div id="port-graph" style="height:200px;width:200px;">
</div>
<!-- END PORT GRAPHS -->
