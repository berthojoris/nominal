...
function initialize() {
    ...
    var mapOptions = {
        mapTypeId: 'roadmap',
        zoom: 15,
        center: new google.maps.LatLng(<?php echo $data[0]->latitude;?>, <?php echo $data[0]->longitude;?>)
    };
    var mark = icons['ico'+<?php echo $data[0]->kode_tipe_uker;?>+'_'+<?php echo ($data[0]->status_onoff!=NULL) ? $data[0]->status_onoff : 'null' ;?>]; 
    var letak = new google.maps.LatLng(<?php echo $data[0]->latitude;?>, <?php echo $data[0]->longitude;?>);
