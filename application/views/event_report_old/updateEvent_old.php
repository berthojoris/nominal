...
<section style="margin-bottom: -20px">
    <div style="width:100%;height:38px;" class="panel panel-default">
      <ol class="breadcrumb" style="background: white;">
        ...
        <li><a href="<?php echo base_url().'index.php/Dashboard/tableEvent/' ?>">Shifting Report</a></li>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
				...
				<?php if($type_report=="1"){?>
					...
					<div class="col-md-9">
						<?php include('plan_and_maintenance_update_form.php');?>
					</div>
				<?php }?>
				
				<?php if($type_report=="2"){?>
					<div class="col-md-9">
						<?php include('incident_update_form.php');?>
					</div>
				<?php }?>

				<?php if($type_report=="3"){?>
					<div class="col-md-9">
						<?php include('activity_update_form.php');?>
					</div>
				<?php }?>
