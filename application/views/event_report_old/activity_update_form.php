<form class="col-md-12" id="activity_form" data="3">
	...
	<div class="col-md-12">
		...
		<div class='input-group date'>
			<?php  $datetime = new DateTime( $start_time );   ?>
	  		<input type="text" name="start_time" id="start_time_activity" class="form-control start_time" value="<?php echo $datetime->format('Y-m-d H:i:s'); ?>"></input><br>
	...
	<div class="col-md-12">
		...
		<div class='input-group date'>
			...
			<input type="text" name="end_time" id="end_time_activity" class="form-control end_time" value="<?php echo $datetime->format('Y-m-d H:i:s'); ?>"></input><br>
			<span class="input-group-addon">
			     <span class="glyphicon glyphicon-calendar"></span>
			</span>
		</div>
	...
	<div class="col-md-12">
		...
		<input type="reset" id="activity" name="btn_cancel" class="btn btn-danger" value="back" onclick="window.location='<?=base_url()?>index.php/EventReport/tableEvent' "/>&nbsp;
	</div>
</form>
