    ...
    <div class="row">
        <div class="panel panel-default" style="width:49%;float: left;"> 
			...
			<div class="panel-body">
				...
				<form action="<?php echo base_url();?>index.php/Troubleshoot/ping" method="post" id="form_ping" onsubmit="POPUPW = window.open('about:blank','POPUPW', 'width=600,height=400');">
				...
				<button type="submit" class="btn btn-block btn-primary">Ping!!!</button>
		...
		<div class="panel panel-default" style="width:49%;float: right;"> 
            <div class="panel-heading" align="center" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">Result Ping Network</div>
			<div class="panel-body">
				<!--<div id="result_ping" style="width:100%;height:430px;overflow:auto;">-->
