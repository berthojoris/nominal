...
<script type="text/javascript">
    $(document).ready(function() {
		...
		var myForm = document.getElementById('form_traceroute');
...
<section style="margin-bottom: 30px">
    ...
    <ol class="breadcrumb"  style="background: white;">
      ...
      <li >Troubleshoot</li>
	  <li class="active" style="color: #3C8DBC;">Traceroute</li>
    </ol>
  </div>   
</section>
<section class="content" style="margin-top:-30px;">   
    <div class="row">
        <div class="panel panel-default" style="width:49%;float: left;"> 
			...
			<div class="panel-body">
				<div class="form-group">
								<form action="<?php echo base_url();?>index.php/Troubleshoot/traceroute" method="post" id="form_traceroute" onsubmit="POPUPW = window.open('about:blank','POPUPW', 'width=600,height=400');">
				...
				<span class="input-group-btn" style="width: 0%;">
									  <button type="submit" class="btn btn-block btn-primary">Traceroute!!!</button>
									</span>
				</form>
					</div>
			</div>			
		...
		<div class="panel panel-default" style="width:49%;float: right;"> 
            <div class="panel-heading" align="center" style="background-color:#3C8DBC;color:#FFFFFF;font-weight:bold;font-size:14pt;">Traceroute Result</div>
			<div class="panel-body">
				<div id="result_trace" style="width:100%;height:430px;">
					
					<iframe style="width:100%;height:100%;border:1px solid #cecece;" name="traceres" >
					</iframe>
