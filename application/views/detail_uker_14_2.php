...
<section>
    <div style="width:100%;height:38px;" class="panel panel-default">
      <ol class="breadcrumb" style="background: white;">
        ...
        <li><a href="<?php echo base_url().'index.php/Dashboard/new_list_remote/'.$data[0]->kode_kanca."/".$this->uri->segment(4); ?>">Remote List</a></li>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php 
                                ...
                                }else if($data[0]->status_onoff==1 && $data[0]->kode_op==2  || ( $data[0]->kode_op==1 && $data[0]->status_onoff==1 && in_array($data[0]->kode_tipe_uker, array(6,8,9,10,11,12,13)) ) ){
                                    ...
                                    <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <div class="form-group">
										  ...
										  <input type="hidden" name="kode_kanca_tetap" class="form-control" value="<?php echo $data[0]->kode_kanca;?>" data-inputmask="'alias': 'ip'" data-mask <?php echo $this->session->userdata('role') != 1 ? '' : ''?>>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="input-group">
											...
											<input type="hidden" name="ip_lan_tetap" class="form-control" value="<?php echo $data[0]->ip_lan;?>" data-inputmask="'alias': 'ip'" data-mask <?php echo $this->session->userdata('role') != 1 ? '' : ''?>>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          ...
                                          <div class="input-group">
                                            ...
                                            <input type="text" name="ip_monitoring" class="form-control" value="<?php echo $data[0]->ip_monitoring;?>" data-inputmask="'alias': 'ip'" data-mask <?php if( !in_array($this->session->userdata('role'), array(1,5)) ){ echo 'disabled';}?>>
                                            <input type="hidden" name="ip_monitoring_old" value="<?php echo $data[0]->ip_monitoring;?>">
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label>ADDRESS</label>
...
function initialize()
{
	mymap = L.map('map-canvas').setView([<?php echo $data[0]->latitude;?>,<?php echo $data[0]->longitude;?>], 16);
...
function getLocationOnMap() {
	...
	var marker = L.marker([<?php echo $latitude;?>,<?php echo $longitude;?>], {icon: iconmarker}).addTo(mymap);
